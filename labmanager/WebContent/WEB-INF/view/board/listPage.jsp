...
<table width="500" cellpadding="0" cellspacing="0" border="1">
	...
	<tr>
		<td>${board.bno}</td>
		<td><a href='/labmanager/board/readPage${pageMaker.makeSearch(pageMaker.cri.page)
...
<script src="resource/vender/jquery-3.2.1.min.js"></script>
<script type="text/javascript" language="javascript" src="<c:url value="resource/js/board.js?ver=1"/>"></script>
</body>
</html>